...
public class FiltroSaidaServico implements Serializable {
    ...
    public FiltroSaidaServico() {
    }

    public FiltroSaidaServico(boolean checkCliente, boolean checkDataCriacao, String clienteNome, String dataCadastro) {
